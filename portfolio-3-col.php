...
<title>Three Column Portfolio - CreaTec Responsive Multipurpose HTML5 Bootstrap Startup Business Website Template</title>
...
<section class="qt-middle">
  ...
  <div class="qt-featured-image qt-header-featured-image qt-header-featured-image-wide">
    <img src="resources/img/featured-1.jpg" alt="About Us">
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="qt-page-header">
          <h2>Three Column Portfolio<small> - Subheading</small></h2>
          <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
        ...
        <div class="qt-page-body qt-portfolio qt-portfolio-3-col">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/1.jpg" alt="">
                </a>
            ...
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/2.jpg" alt="">
                </a>
            ...
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/3.jpg" alt="">
                </a>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/7.jpg" alt="">
                </a>
                <h3><a href="#">Project Seven</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            ...
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/8.jpg" alt="">
                </a>
                <h3><a href="#">Project Eight</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
            ...
            <div class="col-md-4">
              ...
              <div class="qt-portfolio-item">
                <a href="portfolio-single-item-1.php">
                  <img class="img-responsive qt-fade" src="resources/img/portfolio/9.jpg" alt="">
                </a>
                <h3><a href="#">Project Nine</a></h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae.</p>
...
<?php include 'parts/footer-gallery.php'; ?>
