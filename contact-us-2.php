...
<meta name="description" content="Contact Us - CreaTec Responsive Multipurpose HTML5 Bootstrap Startup Business Website Template">

<title>Contact Us - CreaTec Responsive Multipurpose HTML5 Bootstrap Startup Business Website Template</title>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="qt-page-header">
          <h2>Let's Get In Touch! <small> - How to reach us</small></h2>
        </div>
      ...
      <div class="col-md-4">
        ...
        <?php include 'parts/sidebar-contact.php'; ?>
